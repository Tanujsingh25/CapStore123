...
public class User_details {
	...
	public User_details(String first_name, String last_name, String email, String contact, String password, String enc_password,
			String user_type) {
		super();
	...
	public String toString() {
		return "User_details [user_id=" + user_id + ", email=" + email + ", first_name=" + first_name + ", last_name="
				+ last_name + ", contact=" + contact + ", password=" + password + ", enc_password=" + enc_password
				+ ", user_type=" + user_type + ", address=" + address + ", cart=" + cart + ", wishlist=" + wishlist
				+ "]";
	}
}